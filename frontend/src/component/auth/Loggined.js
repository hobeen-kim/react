    ...
    let options = {
      ...
      return (
        <SectionsContainer {...options}>
            <Section>
              <div class='loggined-section'>환영합니다!</div>
                <div class='loggined-div'>
                  <div class='content'>설명 보기</div>
                  <img class='loggined-img'src={Scrolldown} alt="scrollDown"/>
                </div>
            </Section>
            <Section>
            <h1 class='loggined-sectionIn'>선수 관리 페이지</h1>
            <div class='flex-container'>
              <img class='img-gif' src={Guide1} alt="guide1"/>
              <div class='loggined-content'>
              <br/>
            ...
            <div class='loggined-flex-container'>
              <img class='loggined-img loggined-div'src={Scrolldown} alt="scrollDown"/>
            </div>
            </Section>
            <Section>
            <h1 class='loggined-sectionIn'>경기 관리 페이지</h1>
            <div class='flex-container'>
              <img class='img-gif' src={Guide2} alt="guide2"/>
              <div class='loggined-content'>
              <br/>
                <br/>
                <h2>경기 생성</h2><br/>
            ...
            <Section>
            <h1 class='loggined-sectionIn'>히트맵 툴바</h1>
            <div class='flex-container'>
              <img class='img-gif' src={Guide3} alt="guide3"/>
              <div class='loggined-content'>
              <br/>
                <br/>
              ...
              <div class='loggined-content' style={{marginLeft:'200px', textAlign:"left"}}>
              <br/><br/>
                <h2>주요 단축키</h2><br/>
                시간 1분 더하기 : S<br/><br/>
                시간 1분 빼기 : A<br/><br/>
            ...
            <Section>
            <h1 class='loggined-sectionIn'>히트맵 만들기</h1>
            <div class='flex-container'>
              <img class='img-gif' src={Guide4} alt="guide4"/>
              <div class='loggined-content'>
                <br/><br/>
                <h2>슈팅 기록</h2><br/>
            ...
            <Section>
              <div class='loggined-section'>
                <h1 >이제 팀 관리를 시작해보세요!</h1>
                <br/>
                <img class='pointer-img' src={PointerImg} alt="pointer"/>
                <button class='loggined-button' onClick={()=>navigate('/players')}>선수 관리</button>
                <button class='loggined-button' onClick={()=>navigate('/games')}>경기 관리</button>
                <img class='pointer-img-reverse' src={PointerImg} alt="pointer"/>
                <br/><br/>
              </div>
              <div class='loggined-div'>
