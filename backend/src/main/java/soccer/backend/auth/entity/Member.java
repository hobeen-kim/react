...
public class Member implements Serializable {
    ...
    // member 와 생명주기를 같이 하기 때문에 cascade = CascadeType.ALL
    ...
    public Member(String email, String memberId, String password, String name, String nickname, Authority authority) {
        this.email = email;
        this.memberId = memberId;
        this.password = password;
        this.name = name;
