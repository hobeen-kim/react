package soccer.backend.domain.game.service;
...
import soccer.backend.domain.dotrecord.repository.DotRecordRepository;
import soccer.backend.domain.game.entity.Game;
import soccer.backend.domain.game.dto.*;
import soccer.backend.domain.game.repository.GamePlayerRepository;
import soccer.backend.domain.game.repository.GameRepository;
...
public class GameService {
    ...
    public GameListResponseDto gameUpdate(Long gameId, GameUpdateRequestDto request) {
...
//            gamePlayerRepository.deleteByGameId(gameId);
    ...
    //게임 내 선수의 기록을 업데이트
    public RecordResponseDto updatePlayer(Long gameId, Long playerId, RecordRequestDto request) {
    ...
    //게임 내 DotRecord 를 추가
    public GameFieldResponseDto createGameField(Long gameId, GameFieldRequestDto request) {
